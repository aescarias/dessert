...
The `struct` statement defines a structure, an ordered sequence of named elements called fields. Each struct field has a name, a type, and optionally, a set of modifiers. Each field ends with a semicolon (`;`).
