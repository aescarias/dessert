...
|endian
|string
|(required) The byte endianness assumed for all integer sfields in the structure. This must either be the string "little" or the string "big", meaning little-endian byte order and big-endian or network byte order, respectively.
